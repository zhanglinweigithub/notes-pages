var ie=Object.getPrototypeOf;var le=Reflect.get;var Z=(e,t,s)=>le(ie(e),s,t);import{c as y,p as Pt,e as k,b as Dt,o as P,i as B,C as re,u as g,f as At,g as ue,h as Mt,j as st,D as ce,k as at,l as _,n as de,m as w,q as Ot,r as nt,t as Vt,v as G,w as Lt,H as ot,x as j,y as pe,z as me,A as ve,B as Ct,s as It,E as fe,F as be,G as $e,I as he,J as m,P as ge,K as ye,L as _e,N as Bt,O as Rt,d as it}from"./vidstack-DN6tvCiJ-D_QLxuds.js";import{e as xe,c as Ce,t as wt,A as we,l as lt,D as Te,x as n,o as ke,n as E,L as rt,i as Se,a as Ft}from"./vidstack-CbhL8rpf-C0Lj70YY.js";import{m as Et}from"./app-Vg0IViah.js";class Pe extends Ce{constructor(t){super(t),this.h=null,this.w=!1,this.ra=null,this.w=t.type===wt.ATTRIBUTE||t.type===wt.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Si()),this.h?this.el(Pt(this.h)):we}reconnected(){this.Si()}disconnected(){var t;(t=this.ra)==null||t.call(this),this.ra=null}Si(){this.h&&(this.ra=k(this.o.bind(this)))}el(t){return this.w?lt(t):t}hl(t){this.setValue(this.el(t))}o(){var t;this.hl((t=this.h)==null?void 0:t.call(this))}}function i(e){return xe(Pe)(y(e))}class Nt{constructor(t,s){this.Wj=t,this.Ca=s,this.elements=new Set,this.vf=Dt(this.ea.bind(this))}connect(){this.ea();const t=new MutationObserver(this.vf);t.observe(this.Wj,{childList:!0,subtree:!0}),P(()=>t.disconnect()),P(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){t instanceof Node?(s.textContent="",s.append(t)):Te(t,s),s.style.display||(s.style.display="contents");const a=s.firstElementChild;if(!a)return;const o=s.getAttribute("data-class");o&&a.classList.add(...o.split(" "))}ea(t){if(t&&!t.some(o=>o.addedNodes.length))return;let s=!1,a=this.Wj.querySelectorAll("slot");for(const o of a)!o.hasAttribute("name")||this.elements.has(o)||(this.elements.add(o),s=!0);s&&this.Ca(this.elements)}}let De=0,N="data-slot-id";class ut{constructor(t){this.Wj=t,this.vf=Dt(this.ea.bind(this)),this.slots=new Nt(t,this.ea.bind(this))}connect(){this.slots.connect(),this.ea();const t=new MutationObserver(this.vf);t.observe(this.Wj,{childList:!0}),P(()=>t.disconnect())}ea(){for(const t of this.Wj.children){if(t.nodeType!==1)continue;const s=t.getAttribute("slot");if(!s)continue;t.style.display="none";let a=t.getAttribute(N);a||t.setAttribute(N,a=++De+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==s||o.getAttribute(N)===a)continue;const l=document.importNode(t,!0);s.includes("-icon")&&l.classList.add("vds-icon"),l.style.display="",l.removeAttribute("slot"),this.slots.assign(l,o),o.setAttribute(N,a)}}}}function jt({name:e,class:t,state:s,paths:a,viewBox:o="0 0 32 32"}){return n`<svg
  ...
  >
    ${B(a)?ke(a):i(a)}
  </svg>`}class Ae{constructor(t){this.Wj=t,this.Zj={},this.bk=!1,this.slots=new Nt(t,this.ck.bind(this))}connect(){this.slots.connect(),P(this.disconnect.bind(this))}load(){this.xe().then(t=>{this.Zj=t,this.bk=!0,this.ck()})}disconnect(){for(const{slot:t}of this.dk())t.textContent=""}*dk(){for(const t of Object.keys(this.Zj)){const s=`${t}-icon`;for(const a of this.slots.elements)a.name===s&&(yield{icon:this.Zj[t],slot:a})}}ck(){if(this.bk)for(const{icon:t,slot:s}of this.dk())this.slots.assign(t,s)}}class Gt extends Ae{connect(){super.connect();const t=this.Wj.parentElement;if(!t)return;let s,a=new IntersectionObserver(o=>{var l;(l=o[0])!=null&&l.isIntersecting&&(s==null||s(),s=void 0,this.load())});a.observe(t),s=P(()=>a.disconnect())}}const Wt=Mt();function c(){return st(Wt)}const Me={customIcons:!1,disableTimeSlider:!1,menuGroup:"bottom",noGestures:!1,noKeyboardActionDisplay:!1,noModal:!1,noScrubGesture:!1,playbackRates:ce,seekStep:10,sliderChaptersMinWidth:325,smallWhen:!1,thumbnails:null,translations:null,when:!1};var Oe=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,ct=(e,t,s,a)=>{for(var o=a>1?void 0:a?Ve(t,s):t,l=e.length-1,r;l>=0;l--)(r=e[l])&&(o=(a?r(t,s,o):r(o))||o);return a&&o&&Oe(t,s,o),o};const yt=class yt extends re{constructor(){super(...arguments),this._m=y(()=>{const t=this.$props.when();return this.$m(t)}),this.Ym=y(()=>{const t=this.$props.smallWhen();return this.$m(t)}),this.menuContainer=null}get isMatch(){return this._m()}get isSmallLayout(){return this.Ym()}onSetup(){this.a=g(),this.setAttributes({"data-match":this._m,"data-size":()=>this.Ym()?"sm":null,"data-no-scrub-gesture":this.$props.noScrubGesture});const t=this;At(Wt,{...this.$props,when:this._m,smallWhen:this.Ym,get menuContainer(){return t.menuContainer}})}$m(t){return t!=="never"&&(ue(t)?t:y(()=>t(this.a.player.state))())}};yt.props=Me;let L=yt;ct([at],L.prototype,"menuContainer",2);ct([at],L.prototype,"isMatch",1);ct([at],L.prototype,"isSmallLayout",1);function h(e,t){var s;return((s=e())==null?void 0:s[t])??t}function R({label:e,icon:t,hint:s}){return n`
  ...
  `}function Le({value:e=null,options:t,hideLabel:s=!1,children:a=null,onChange:o=null}){function l(r){const{value:b,label:u}=r;return n`
  ...
  `}function Ie(e){return Lt(e)?e.map(t=>({label:t,value:t.toLowerCase()})):Object.keys(e).map(t=>({label:t,value:e[t]}))}const dt=["White","Yellow","Green","Cyan","Blue","Magenta","Red","Black"],pt=["0%","25%","50%","75%","100%"],Be={"Monospaced Serif":"mono-serif","Proportional Serif":"pro-serif","Monospaced Sans-Serif":"mono-sans","Proportional Sans-Serif":"pro-sans",Casual:"casual",Cursive:"cursive","Small Capitals":"capitals"},Re=["50%","75%","100%","150%","200%","300%","400%"],Fe=["None","Drop Shadow","Raised","Depressed","Outline"],mt=Mt();function Ee(){return i(()=>{const{hasCaptions:e}=_(),{translations:t}=c();return e()?(At(mt,{all:new Set}),n`
    ...
    `):null})}function Ne(){return M({label:"Font Family",options:Be,defaultValue:"pro-sans",cssVarName:"font-family",getCssVarValue(e,t){var a;const s=e==="capitals"?"small-caps":"";return(a=t.el)==null||a.style.setProperty("--media-user-font-variant",s),Qe(e)}})}function je(){return M({label:"Font Size",options:Re,defaultValue:"100%",cssVarName:"font-size",getCssVarValue:q})}function Ge(){return M({label:"Text Color",options:dt,defaultValue:"white",cssVarName:"text-color",getCssVarValue(e){return`rgb(${vt(e)} / var(--media-user-text-opacity, 1))`}})}function We(){return M({label:"Text Opacity",options:pt,defaultValue:"100%",cssVarName:"text-opacity",getCssVarValue:q})}function Ke(){return M({label:"Text Shadow",options:Fe,defaultValue:"none",cssVarName:"text-shadow",getCssVarValue:Ze})}function qe(){return M({label:"Background Color",options:dt,defaultValue:"black",cssVarName:"text-bg",getCssVarValue(e){return`rgb(${vt(e)} / var(--media-user-text-bg-opacity, 1))`}})}function Ue(){return M({label:"Background Opacity",options:pt,defaultValue:"100%",cssVarName:"text-bg-opacity",getCssVarValue:q})}function ze(){return M({label:"Display Background Color",options:dt,defaultValue:"black",cssVarName:"display-bg",getCssVarValue(e){return`rgb(${vt(e)} / var(--media-user-display-bg-opacity, 1))`}})}function Ye(){return M({label:"Display Background Opacity",options:pt,defaultValue:"0%",cssVarName:"display-bg-opacity",getCssVarValue:q})}function He(){const{translations:e}=c(),t=()=>h(e,"Reset"),s=st(mt);function a(){s.current?s.current():s.all.forEach(o=>o())}return n`
    <button class="vds-menu-button" role="menuitem" @click=${a}>
      <span class="vds-menu-button-label">${i(t)}</span>
    </button>
  `}function M({label:e,options:t,defaultValue:s,cssVarName:a,getCssVarValue:o}){const{player:l}=g(),{translations:r}=c(),b=st(mt),u=Ie(t),f=`${e.toLowerCase().replace(/\s/g,"-")}`,d=w(s),x=()=>h(r,e),C=()=>{var xt;const S=d(),I=((xt=u.find(oe=>oe.value===S))==null?void 0:xt.label)||"";return h(r,B(I)?I:I())},$=localStorage.getItem(`vds-player:${f}`);$&&D($);function D(S){var I;d.set(S),localStorage.setItem(`vds-player:${f}`,S),(I=l.el)==null||I.style.setProperty(`--media-user-${a}`,(o==null?void 0:o(S,l))??S)}b.all.add(O),P(()=>void b.all.delete(O));function O(){D(s)}function T(){b.current=O}function A(){b.current=void 0}return n`
    <media-menu class=${`vds-${f}-menu vds-menu`} @open=${T} @close=${A}>
      ${R({label:x,hint:C})}
      <media-menu-items class="vds-menu-items">
        ${Le({value:d,options:u,onChange({detail:S}){D(S)}})}
      </media-menu-items>
    </media-menu>
  `}function q(e){return(parseInt(e)/100).toString()}function vt(e){switch(e){case"white":return"255 255 255";case"yellow":return"255 255 0";case"green":return"0 128 0";case"cyan":return"0 255 255";case"blue":return"0 0 255";case"magenta":return"255 0 255";case"red":return"255 0 0";case"black":return"0 0 0"}}function Qe(e){switch(e){case"mono-serif":return'"Courier New", Courier, "Nimbus Mono L", "Cutive Mono", monospace';case"mono-sans":return'"Deja Vu Sans Mono", "Lucida Console", Monaco, Consolas, "PT Mono", monospace';case"pro-sans":return'Roboto, "Arial Unicode Ms", Arial, Helvetica, Verdana, "PT Sans Caption", sans-serif';case"casual":return'"Comic Sans MS", Impact, Handlee, fantasy';case"cursive":return'"Monotype Corsiva", "URW Chancery L", "Apple Chancery", "Dancing Script", cursive';case"capitals":return'"Arial Unicode Ms", Arial, Helvetica, Verdana, "Marcellus SC", sans-serif + font-variant=small-caps';default:return'"Times New Roman", Times, Georgia, Cambria, "PT Serif Caption", serif'}}function Ze(e){switch(e){case"drop shadow":return"rgb(34, 34, 34) 1.86389px 1.86389px 2.79583px, rgb(34, 34, 34) 1.86389px 1.86389px 3.72778px, rgb(34, 34, 34) 1.86389px 1.86389px 4.65972px";case"raised":return"rgb(34, 34, 34) 1px 1px, rgb(34, 34, 34) 2px 2px";case"depressed":return"rgb(204, 204, 204) 1px 1px, rgb(34, 34, 34) -1px -1px";case"outline":return"rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px";default:return""}}function Kt({tooltip:e}){const{translations:t}=c(),{remotePlaybackState:s}=_(),a=i(()=>{const l=h(t,"AirPlay"),r=Vt(s());return`${l} ${r}`}),o=p(t,"AirPlay");return n`
  ...
  `}function Je(){const{translations:e}=c(),{pictureInPicture:t}=_(),s=i(()=>h(e,t()?"Exit PiP":"Enter PiP")),a=p(e,"Enter PiP"),o=p(e,"Exit PiP");return n`
  ...
  `}function ts(){return i(()=>{const{live:e,duration:t}=_();return e()?Yt():t()?n`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function z(){return n`<div class="vds-controls-spacer"></div>`}function Ht(){return i(()=>{const{live:e}=_();return e()?Yt():Xe()})}function Qt(e,t){return n`
  ...
  `}function Jt({placement:e,portal:t,tooltip:s}){return i(()=>{const{viewType:a,canSetPlaybackRate:o,canSetQuality:l,qualities:r,audioTracks:b,hasCaptions:u}=_(),{translations:f,menuContainer:d,noModal:x,menuGroup:C,smallWhen:$}=c(),D=y(()=>x()?G(e):$()?null:G(e)),O=y(()=>!$()&&C()==="bottom"&&a()==="video"?26:0);if(!y(()=>o()||!!(l()&&r().length)||!!b().length||u())())return null;const A=n`
    ...
    `})}function es(){const{translations:e}=c(),t=p(e,"Default");return n`
  ...
  `}function ss(){const{translations:e,playbackRates:t}=c(),s=p(e,"Normal");return n`
  ...
  `}function as(){const{translations:e}=c(),t=p(e,"Auto");return n`
  ...
  `}function ns(){const{translations:e}=c(),t=p(e,"Off");return n`
  ...
  `}function Xt(e){let t=document.querySelector(`body > .${e}`);return t||(t=document.createElement("div"),t.style.display="contents",t.classList.add(e),document.body.append(t)),t}function p(e,t){return i(()=>h(e,t))}class te extends Gt{async xe(){const t=(await Et(()=>import("./vidstack-CYAAeb3D-5TedbxCU.js"),__vite__mapDeps([0,1]))).icons,s={};for(const a of Object.keys(t))s[a]=jt({name:a,paths:t[a]});return s}}var V;let os=(V=class extends L{},V.props={...Z(V,V,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},V);function is(){return[n`<media-captions class="vds-captions"></media-captions>`,n`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
          ${[Tt({backward:!0,tooltip:"top start"}),U({tooltip:"top"}),Tt({tooltip:"top"}),ls(),$t(),ts(),rs(),bt({tooltip:"top"}),us()]}
        </media-controls-group>
      </media-controls>
    `]}function ls(){return i(()=>{let e=w(void 0),t=w(!1),s=g(),{title:a,started:o,currentTime:l,ended:r}=_(),{translations:b}=c(),u=pe(e),f=()=>o()||l()>0;const d=()=>{const $=r()?"Replay":f()?"Continue":"Play";return`${h(b,$)}: ${a()}`};k(()=>{var $;u()&&document.activeElement===document.body&&(($=s.player.el)==null||$.focus())});function x(){const $=e(),D=!!$&&!u()&&$.clientWidth<$.children[0].clientWidth;$&&fe($,"vds-marquee",D),t.set(D)}function C(){return n`
      ...
      `}return Ot(e,x),a()?n`
        ...
        `:z()})}function rs(){return i(()=>{const{pointer:e,muted:t}=_();if(e()==="coarse"&&!t())return null;const s=w(void 0),a=w(void 0),o=w(void 0),l=me(s),r=ve(a);return k(()=>{r()&&(Ct(s,a,"trigger"),Ct(s,o,"popper"))}),n`
    ...
    `})}function us(){const e="top end";return[Zt({tooltip:"top",placement:e,portal:!0}),Jt({tooltip:"top end",placement:e,portal:!0})]}const W=class W extends ot(rt,os){constructor(){super(...arguments),this.jn=w(!1)}onSetup(){this.forwardKeepAlive=!1,this.a=g(),this.classList.add("vds-audio-layout"),this.menuContainer=Xt("vds-audio-layout"),k(()=>{this.menuContainer&&It(this.menuContainer,"data-size",this.isSmallLayout&&"sm")});const{pointer:t}=this.a.$state;k(()=>{t()==="coarse"&&k(this.kn.bind(this))}),P(()=>{var s;return(s=this.menuContainer)==null?void 0:s.remove()})}onConnect(){var t;(t=this.a.player.el)==null||t.setAttribute("data-layout","audio"),P(()=>{var s;return(s=this.a.player.el)==null?void 0:s.removeAttribute("data-layout")}),k(()=>{this.$props.customIcons()?new ut(this).connect():new te(this).connect()})}render(){return n`${i(this._j.bind(this))}`}_j(){return this.isMatch?is():null}kn(){if(!this.jn()){j(this,"pointerdown",this.ln.bind(this),{capture:!0});return}j(this,"pointerdown",t=>t.stopPropagation()),j(window,"pointerdown",this.mn.bind(this))}ln(t){const{target:s}=t;s instanceof HTMLElement&&s.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.jn.set(!0))}mn(){this.jn.set(!1),this.removeAttribute("data-scrubbing")}};W.tagName="media-audio-layout",W.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let J=W;const F=class F extends L{};F.props={...Z(F,F,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380};let X=F;function cs(){return i(()=>{const e=w(!1),t=g(),{noKeyboardActionDisplay:s}=c(),{lastKeyboardAction:a}=t.$state;if(s())return null;k(()=>{e.set(!!a());const d=setTimeout(()=>e.set(!1),500);return()=>{e.set(!1),window.clearTimeout(d)}});const o=y(()=>{var x;const d=(x=a())==null?void 0:x.action;return d&&e()?be(d):null}),l=y(()=>`vds-kb-action${e()?"":" hidden"}`),r=y(ds),b=y(ms),u=y(()=>{const d=ps();return d?$e(d):null});function f(){return u()?n`
    ...
    `})}function ds(){var s;const{$state:e}=g();switch((s=e.lastKeyboardAction())==null?void 0:s.action){case"toggleMuted":return e.muted()?"0%":kt(e.volume());case"volumeUp":case"volumeDown":return kt(e.volume());default:return""}}function kt(e){return`${Math.round(e*100)}%`}function ps(){var s;const{$state:e}=g();switch((s=e.lastKeyboardAction())==null?void 0:s.action){case"togglePaused":return e.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return e.muted()||e.volume()===0?"kb-mute-icon":e.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${e.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${e.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return e.hasCaptions()?`kb-cc-${e.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";default:return null}}function ms(){const e=vs(),{translations:t}=c();return e?h(t,e):null}function vs(){var a,o;const{$state:e}=g(),t=(a=e.lastKeyboardAction())==null?void 0:a.action,{translations:s}=c();switch(t){case"togglePaused":return e.paused()?"Pause":"Play";case"toggleFullscreen":return e.fullscreen()?"Enter Fullscreen":"Exit Fullscreen";case"togglePictureInPicture":return e.pictureInPicture()?"Enter PiP":"Exit PiP";case"toggleCaptions":return e.textTrack()?"Closed-Captions On":"Closed-Captions Off";case"toggleMuted":case"volumeUp":case"volumeDown":return e.muted()||e.volume()===0?"Mute":`${Math.round(e.volume()*100)}% ${((o=s())==null?void 0:o.Volume)??"Volume"}`;default:return null}}function fs(){return[ee(),Y(),cs(),n`<media-captions class="vds-captions"></media-captions>`,n`<div class="vds-scrim"></div>`,n`
      <media-controls class="vds-controls">
        ${[$s(),z(),n`
          ...
          `,n`
            <media-controls-group class="vds-controls-group">
              ${[U({tooltip:"top start"}),ft({tooltip:"top"}),zt(),Ht(),ht(),bt({tooltip:"top"}),bs(),Kt({tooltip:"top"}),qt({tooltip:"top"}),Je(),Ut({tooltip:"top end"})]}
            </media-controls-group>
          `]}
      </media-controls>
    `]}function bs(){return i(()=>{const{menuGroup:e}=c();return e()==="bottom"?gt():null})}function $s(){return n`
    <media-controls-group class="vds-controls-group">
  ...
  `}function ys(){return i(()=>{const{duration:e}=_();return e()===0?null:n`
  ...
  `}function gt(){const{menuGroup:e,smallWhen:t}=c(),s=()=>e()==="top"||t()?"bottom":"top",a=y(()=>`${s()} ${e()==="top"?"end":"center"}`),o=y(()=>`${s()} end`);return[Zt({tooltip:a,placement:o,portal:!0}),Jt({tooltip:a,placement:o,portal:!0})]}function ee(){return i(()=>{const{noGestures:e}=c();return e()?null:n`
    ...
    `})}const K=class K extends ot(rt,X){onSetup(){this.forwardKeepAlive=!1,this.a=g(),this.classList.add("vds-video-layout"),this.menuContainer=Xt("vds-video-layout"),k(()=>{this.menuContainer&&It(this.menuContainer,"data-size",this.isSmallLayout&&"sm")}),P(()=>{var t;return(t=this.menuContainer)==null?void 0:t.remove()})}onConnect(){var t;(t=this.a.player.el)==null||t.setAttribute("data-layout","video"),P(()=>{var s;return(s=this.a.player.el)==null?void 0:s.removeAttribute("data-layout")}),k(()=>{this.$props.customIcons()?new ut(this).connect():new te(this).connect()})}render(){return n`${i(this._j.bind(this))}`}_j(){const{load:t}=this.a.$props,{canLoad:s,streamType:a}=this.a.$state;return this.isMatch?t()==="play"&&!s()?gs():a()==="unknown"?Y():this.isSmallLayout?hs():fs():null}};K.tagName="media-video-layout",K.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let tt=K;class _s extends Gt{async xe(){const t=(await Et(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),__vite__mapDeps([]))).icons,s={};for(const a of Object.keys(t))s[a]=jt({name:a,paths:t[a],viewBox:"0 0 18 18"});return s}}function H(e,t){var s;return((s=e())==null?void 0:s[t])??t}function xs(){return ks()}function Cs(){const e=g(),{load:t}=e.$props,{canLoad:s}=e.$state;return y(()=>t()==="play"&&!s())()?[se(),St()]:[ws(),Ts(),St(),Ss(),Gs(),Ws()]}function se(){const e=g(),{translations:t}=m(),{title:s}=e.$state,a=i(()=>`${H(t,"Play")}, ${s()}`);return n`
    <media-play-button
  ...
  `}function As(){const{translations:e}=m(),t=v(e,"Enter Fullscreen"),s=v(e,"Exit Fullscreen");return n`
    <media-fullscreen-button
      class="plyr__controls__item plyr__control"
      data-no-label
  ...
  `}function Ms(){const{translations:e}=m(),t=v(e,"Mute"),s=v(e,"Unmute");return n`
  ...
  `}function Ls(){const{translations:e}=m(),{remote:t}=g(),s=v(e,"Restart");function a(o){Bt(o)&&!Rt(o)||t.seek(0,o)}return n`
    <button
      type="button"
      class="plyr__control"
      data-plyr="restart"
  ...
  `}function Fs(e){return i(()=>{const t=e==="mute"||e==="mute+volume",s=e==="volume"||e==="mute+volume";return n`
    ...
    `})}function Es(){const{translations:e}=m(),t=v(e,"Volume");return n`
    <media-volume-slider class="plyr__slider" data-plyr="volume" aria-label=${t}>
      <div class="plyr__slider__track"></div>
      <div class="plyr__slider__thumb"></div>
    </media-volume-slider>
  `}function Ns(){const e=g(),{translations:t,invertTime:s,toggleTime:a,displayDuration:o}=m(),l=w(Pt(s));function r(u){!a()||o()||Bt(u)&&!Rt(u)||l.set(f=>!f)}function b(){return i(()=>o()?ne():null)}return i(()=>{const{streamType:u}=e.$state,f=v(t,"LIVE"),d=v(t,"Current time"),x=i(()=>!o()&&l());return u()==="live"||u()==="ll-live"?n`
          <media-live-button
    ...
    <media-time
      ...
      aria-label=${t}
    ></media-time>
  `}function js(){return i(()=>{const e=g(),{translations:t,download:s}=m(),{source:a}=e.$state,o=a(),l=s(),r=B(l)?l:l==null?void 0:l.url,b=(B(l)?null:l==null?void 0:l.filename)||"media",u=v(t,"Download");return r||ye(o)||_e(o)?n`
          <a
            class="plyr__controls__item plyr__control"
        ...
        `:null})}function Gs(){return i(()=>{const{clickToPlay:e,clickToFullscreen:t}=m();return[e()?n`
          ...
          `:null,t()?n`
            <media-gesture
              ...
              action="toggle:fullscreen"
            ></media-gesture>
          `:null]})}function Ws(){const e=g(),t=w(void 0),s=i(()=>{var a;return Ft((a=t())==null?void 0:a.text)});return k(()=>{const a=e.$state.textTrack();if(!a)return;function o(){t.set(a==null?void 0:a.activeCues[0])}return o(),j(a,"cue-change",o)}),n`
  ...
  `}function ta(e){return i(()=>e()?"true":"false")}function v(e,t){return i(()=>H(e,t))}const _t=class _t extends ot(rt,ge){onSetup(){this.forwardKeepAlive=!1,this.a=g()}onConnect(){var t;(t=this.a.player.el)==null||t.setAttribute("data-layout","plyr"),P(()=>{var s;return(s=this.a.player.el)==null?void 0:s.removeAttribute("data-layout")}),he(this,this.a),k(()=>{this.$props.customIcons()?new ut(this).connect():new _s(this).connect()})}render(){return n`${i(this._j.bind(this))}`}_j(){const{viewType:t}=this.a.$state;return t()==="audio"?xs():t()==="video"?Cs():null}};_t.tagName="media-plyr-layout";let et=_t;it(J);it(tt);it(et);
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/vidstack-CYAAeb3D-5TedbxCU.js","assets/vidstack-D8vpzjIs-BTtv5vWE.js"]
  }
